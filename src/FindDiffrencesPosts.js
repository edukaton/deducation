  ...
  legit: {
    ...
    content: (
      <div>
        ...
        </Highlight>, było sprawdzenie, jak psycholodzy oraz policjanci z pionów
        śledczych, oceniają diagnostyczność symptomów kłamstwa, poruszonych w
        literaturze przedmiotu. Ponadto zespół badawczy postanowił sprawdzić,
        czy płeć oraz doświadczenie zawodowe mają wpływ, na wybór tychże
        symptomów.
        <Highlight
          type="ok"
          ...
          mężczyzn) w średnim wieku 37,4 lat oraz 101 psychologów, (72 kobiet i
          29 mężczyzn)
        </Highlight>, w średnim wieku 28 lat, którzy według badaczy, ze względu
        na rodzaj świadczonej pracy, zmuszeni są dokonywać oceny wiarygodności
        rozmowy czy przesłuchiwanego.
        <br />
        <br />
        <Highlight
          type="ok"
